...
from stage_prompts import PLAINTEXT_VISION_PROMPT
...
def main() -> int:
    ...
    result, path = run_vision_test(arguments.images, prompt=PLAINTEXT_VISION_PROMPT, test_type="vision_plaintext", use_response_format=False, parse_json=False)
