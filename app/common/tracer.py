...
class Tracer:
    ...
    @staticmethod
    def set_user_context(telegram_user_id: Optional[int] = None, user_name: Optional[str] = None, state: Optional[str] = None):
    ...
    def log_event(
        ...
        """Record an event to traces.jsonl and the user's specific jsonl file."""
        _ensure_log_dirs()
